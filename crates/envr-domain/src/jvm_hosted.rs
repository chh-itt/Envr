...
use crate::{clojure_java, groovy_java, kotlin_java, scala_java};
...
pub fn hosted_runtime_jdk_mismatch_message(
    ...
    match runtime_key {
        ...
        "clojure" => {
            clojure_java::clojure_jdk_mismatch_message(runtime_version_label, java_dir_label)
        }
        "groovy" => groovy_java::groovy_jdk_mismatch_message(runtime_version_label, java_dir_label),
        _ => None,
    }
}
...
pub fn is_jvm_hosted_runtime(runtime_key: &str) -> bool {
    matches!(runtime_key, "kotlin" | "scala" | "clojure" | "groovy")
}
