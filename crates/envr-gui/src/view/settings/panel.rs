...
pub fn settings_view(state: &SettingsViewState, tokens: ThemeTokens) -> Element<'static, Message> {
    ...
    let runtime_network_card = section_card(
        tokens,
        envr_core::i18n::tr_key(
            "gui.settings.runtime_network",
            "运行时网络与包源（Node/Python/Go/Bun）",
            "Runtime network & package source (Node/Python/Go/Bun)",
        ),
        column![
            setting_row(
                tokens,
                "Node download_source".to_string(),
                None,
                row![
                    button(button_content_centered(text("auto").into()))
                        .on_press(Message::Settings(SettingsMsg::SetNodeDownloadSource(
                            NodeDownloadSource::Auto
                        )))
                        .style(segmented_button_style(
                            tokens,
                            if state.draft.runtime.node.download_source == NodeDownloadSource::Auto {
                                ButtonVariant::Primary
                            } else {
                                ButtonVariant::Secondary
                            },
                    ...
                    button(button_content_centered(text("domestic").into()))
                        .on_press(Message::Settings(SettingsMsg::SetNodeDownloadSource(
                            NodeDownloadSource::Domestic
                        )))
                        .style(segmented_button_style(
                            tokens,
                            if state.draft.runtime.node.download_source == NodeDownloadSource::Domestic {
                                ButtonVariant::Primary
                            } else {
                                ButtonVariant::Secondary
                            },
                    ...
                    button(button_content_centered(text("official").into()))
                        .on_press(Message::Settings(SettingsMsg::SetNodeDownloadSource(
                            NodeDownloadSource::Official
                        )))
                        .style(segmented_button_style(
                            tokens,
                            if state.draft.runtime.node.download_source == NodeDownloadSource::Official {
                                ButtonVariant::Primary
                            } else {
                                ButtonVariant::Secondary
                            },
            ...
            setting_row(
                tokens,
                "Python download_source".to_string(),
                None,
                row![
                    button(button_content_centered(text("auto").into()))
                        .on_press(Message::Settings(SettingsMsg::SetPythonDownloadSource(
            ...
            setting_row(
                tokens,
                "Node npm_registry_mode".to_string(),
                None,
                row![
                    button(button_content_centered(text("auto").into()))
                        .on_press(Message::Settings(SettingsMsg::SetNpmRegistryMode(
                    ...
                    button(button_content_centered(text("restore").into()))
                        .on_press(Message::Settings(SettingsMsg::SetNpmRegistryMode(
            ...
            setting_row(
                tokens,
                "Python pip_registry_mode".to_string(),
                None,
                row![
                    button(button_content_centered(text("auto").into()))
                        .on_press(Message::Settings(SettingsMsg::SetPipRegistryMode(
            ...
            setting_row(
                tokens,
                "Go download_source".to_string(),
                None,
                row![
                    button(button_content_centered(text("auto").into()))
                        .on_press(Message::Settings(SettingsMsg::SetGoDownloadSource(
            ...
            setting_row(
                tokens,
                "Go proxy_mode".to_string(),
                None,
                row![
                    button(button_content_centered(text("auto").into()))
                        .on_press(Message::Settings(SettingsMsg::SetGoProxyMode(GoProxyMode::Auto))),
                    button(button_content_centered(text("official").into()))
                        .on_press(Message::Settings(SettingsMsg::SetGoProxyMode(GoProxyMode::Official))),
                    button(button_content_centered(text("domestic").into()))
                        .on_press(Message::Settings(SettingsMsg::SetGoProxyMode(GoProxyMode::Domestic))),
                    button(button_content_centered(text("custom").into()))
                        .on_press(Message::Settings(SettingsMsg::SetGoProxyMode(GoProxyMode::Custom))),
                ]
                .spacing(sp.sm as f32)
                .into(),
            ),
