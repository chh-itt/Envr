...
fn scala_runtime_settings_section(
    scala: &ScalaRuntimeSettings,
    tokens: ThemeTokens,
) -> Element<'static, Message> {
    let ty = tokens.typography();
    let sp = tokens.space();
    ...
    let proxy_toggle = setting_row(
        ...
        toggler(scala.path_proxy_enabled)
            .label("")
            .size(20.0)
            .spacing(0.0)
            .on_toggle(|v| Message::EnvCenter(EnvCenterMsg::SetJvmPathProxy(RuntimeKind::Scala, v)))
            .into(),
    );
    let proxy_note = text(envr_core::i18n::tr_key(
...
fn terraform_runtime_settings_section(
    terraform: &TerraformRuntimeSettings,
    tokens: ThemeTokens,
) -> Element<'static, Message> {
    let ty = tokens.typography();
    let sp = tokens.space();
    ...
    let proxy_toggle = setting_row(
        ...
        toggler(terraform.path_proxy_enabled)
            .label("")
            .size(20.0)
            .spacing(0.0)
            .on_toggle(|v| Message::EnvCenter(EnvCenterMsg::SetTerraformPathProxy(v)))
            .into(),
    );
    let proxy_note = text(envr_core::i18n::tr_key(
...
fn purescript_runtime_settings_section(
    ps: &PurescriptRuntimeSettings,
    tokens: ThemeTokens,
) -> Element<'static, Message> {
    let ty = tokens.typography();
    let sp = tokens.space();
    ...
    let proxy_toggle = setting_row(
        ...
        toggler(ps.path_proxy_enabled)
            .label("")
            .size(20.0)
            .spacing(0.0)
            .on_toggle(|on| Message::EnvCenter(EnvCenterMsg::SetPurescriptPathProxy(on)))
            .into(),
    );
    let proxy_note = text(envr_core::i18n::tr_key(
...
fn elm_runtime_settings_section(elm: &ElmRuntimeSettings, tokens: ThemeTokens) -> Element<'static, Message> {
    ...
    let proxy_toggle = setting_row(
        ...
        toggler(elm.path_proxy_enabled)
            .label("")
            .size(20.0)
            .spacing(0.0)
            .on_toggle(|on| Message::EnvCenter(EnvCenterMsg::SetElmPathProxy(on)))
            .into(),
    );
    let proxy_note = text(envr_core::i18n::tr_key(
...
fn gleam_runtime_settings_section(
    gleam: &GleamRuntimeSettings,
    tokens: ThemeTokens,
) -> Element<'static, Message> {
    let ty = tokens.typography();
    let sp = tokens.space();
    ...
    let proxy_toggle = setting_row(
        ...
        toggler(gleam.path_proxy_enabled)
            .label("")
            .size(20.0)
            .spacing(0.0)
            .on_toggle(|on| Message::EnvCenter(EnvCenterMsg::SetGleamPathProxy(on)))
            .into(),
    );
    let proxy_note = text(envr_core::i18n::tr_key(
...
fn babashka_runtime_settings_section(
    bb: &BabashkaRuntimeSettings,
    tokens: ThemeTokens,
) -> Element<'static, Message> {
    let ty = tokens.typography();
    let sp = tokens.space();
    ...
    let proxy_toggle = setting_row(
        ...
        toggler(bb.path_proxy_enabled)
            .label("")
            .size(20.0)
            .spacing(0.0)
            .on_toggle(|v| Message::EnvCenter(EnvCenterMsg::SetBabashkaPathProxy(v)))
            .into(),
    );
    let proxy_note = text(envr_core::i18n::tr_key(
...
fn haxe_runtime_settings_section(
    haxe: &HaxeRuntimeSettings,
    tokens: ThemeTokens,
) -> Element<'static, Message> {
    let ty = tokens.typography();
    let sp = tokens.space();
    ...
    let proxy_toggle = setting_row(
        ...
        toggler(haxe.path_proxy_enabled)
            .label("")
            .size(20.0)
            .spacing(0.0)
            .on_toggle(|v| Message::EnvCenter(EnvCenterMsg::SetHaxePathProxy(v)))
            .into(),
    );
    let proxy_note = text(envr_core::i18n::tr_key(
...
pub fn env_center_view(
    ...
    } else if state.kind == RuntimeKind::Purescript {
    ...
    } else if state.kind == RuntimeKind::Gleam {
        gleam_runtime_settings_section(&runtime_settings.gleam, tokens)
    ...
    } else if state.kind == RuntimeKind::Haxe {
        haxe_runtime_settings_section(&runtime_settings.haxe, tokens)
