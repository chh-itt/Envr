...
pub use nested::{
    ...
    DebugCmd, DiagnosticsCmd, EnvShellKind, HelpCmd, HookCmd, HookShell, ProfileCmd, ProjectCmd,
    RustCmd, ShimCmd, ToolCmd,
};
...
impl Command {
    ...
    pub(crate) fn key(&self) -> CommandKey {
        command_key_arms!(
            ...
            Command::Cache(CacheCmd::Runtime(CacheRuntimeCmd::Status { .. })) => CommandKey::CacheRuntimeStatus,
