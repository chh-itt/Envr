...
- `envr install/use purescript 0.15` resolves to the latest known `0.15.x`.
...
- If API discovery fails, envr falls back to `https://github.com/purescript/purescript/releases.atom` and paged GitHub Releases HTML tags, then constructs synthetic download URLs.
